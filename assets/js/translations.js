  ...
  const translations = {
    es: {
      meta: {
        ...
        description:
          "Bolsi es la app más amigable para controlar gastos, compartir presupuestos y ahorrar cada mes.",
      },
      common: {
      ...
      hero: {
        ...
        title: "Bolsi: Gastos y presupuesto sin complicaciones",
        description:
          "¿Cansado de no saber a dónde se va tu dinero? Con Bolsi registras gastos en segundos, compartes con quien quieras y ves alertas antes de pasarte.",
      ...
      benefits: {
        ...
        subheading:
          "Te ayudamos a usar la app todos los días con una experiencia realmente amigable.",
        cards: [
          {
            title: "SÚPER FÁCIL DE USAR",
            description:
              "Registra un gasto en menos de 10 segundos. Diseñada para usarla a diario sin esfuerzo.",
          },
          {
            title: "GASTOS COMPARTIDOS, SIN DRAMAS",
            description:
              "Crea grupos familiares, de pareja o roommates y sincroniza todo en tiempo real.",
          },
          {
            title: "PRESUPUESTOS QUE FUNCIONAN",
            description:
              "Define límites por categoría y recibe alertas tipo semáforo antes de pasarte.",
          },
          {
            title: "PRIVADO Y 100% SEGURO",
            description:
              "Tus datos están cifrados con Firebase. Solo tú decides quién ve tus finanzas.",
          },
        ],
      },
      features: {
        ...
        subheading:
          "Controla gastos fijos y variables, ve estadísticas visuales y mantén la calma ante cualquier pago.",
        list: [
        ...
        cards: {
          ...
          description:
            "Registra compras en cuotas, visualiza tu deuda total y gestiona múltiples tarjetas desde un panel unificado.",
        },
        multiCurrency: {
          title: "Multi-moneda",
          description:
            "Soporta USD, EUR, MXN, ARS, COP, BRL y más. Perfecto para viajeros o quienes manejan diferentes divisas.",
        },
        alerts: {
          title: "Alertas Inteligentes",
          description:
            "Recibe notificaciones cuando te acerques al límite de tus gastos o vencimientos de pagos importantes.",
        },
        darkMode: {
          title: "Modo Oscuro",
          description:
            "Cuida tus ojos con nuestro elegante modo oscuro. Cambia entre claro y oscuro con un toque.",
        },
        reports: {
          title: "Reportes Visuales",
          description:
            "Gráficos de pastel, barras y líneas para entender tus patrones de gasto. Exporta reportes cuando lo necesites.",
        },
        security: {
          title: "Seguridad Firebase",
          description:
            "Tu información protegida con la infraestructura de Google. Respaldo automático y encriptación de datos.",
        },
      },
      howItWorks: {
        ...
        subheading:
          "Configurar tu control de gastos es tan simple que empezarás en menos de 2 minutos.",
        step1: {
          title: "Crea tus gastos fijos",
          description:
            "Define tus gastos mensuales como alquiler, servicios, suscripciones. Bolsi los recordará automáticamente.",
        },
        step2: {
          title: "Registra tus movimientos",
          description:
            "Añade compras y pagos del día a día. Con pocos toques, mantén todo actualizado en tiempo real.",
        },
        step3: {
          title: "Ve tu situación real",
          description:
            "Revisa cuánto te queda disponible, gráficos por categoría y alertas inteligentes para no pasarte de presupuesto.",
        },
        bonus: {
          title: "Comparte con tu familia",
          description:
            "Crea grupos para gestionar gastos compartidos. Perfecto para parejas, familias o roommates que dividen gastos.",
        },
      },
      faq: {
        ...
        subheading:
          "Bolsi está diseñada para acompañarte sin curvas de aprendizaje.",
        items: [
          {
            question: "¿Necesito ser experto en finanzas?",
            answer:
              "No. Bolsi guía cada paso con textos claros, notificaciones y plantillas listas.",
          },
          {
            question: "¿Funciona en varios países?",
            answer:
              "Sí. Soporta múltiples monedas, contextos personales o grupales y se sincroniza en la nube.",
          },
          {
            question: "¿Es gratis?",
            answer:
              "Sí, Bolsi es completamente gratuita. Todas las funciones principales están disponibles sin costo.",
          },
          {
            question: "¿Mis datos están seguros?",
            answer:
              "Absolutamente. Usamos Firebase con cifrado de extremo a extremo. Nadie más que tú tiene acceso a tu información financiera.",
          },
          {
            question: "¿Puedo usarla sin conexión?",
            answer:
              "Sí, puedes registrar gastos sin conexión y se sincronizarán automáticamente cuando vuelvas a tener internet.",
          },
        ],
      },
      audience: {
        ...
        subheading:
          "Sin importar si ahorras solo, en pareja o en familia, Bolsi se adapta a tu ritmo.",
        beginners: {
          title: "Principiantes en finanzas",
          description:
            "¿Quieres empezar a ahorrar pero no sabes por dónde? Bolsi te guía paso a paso sin tecnicismos.",
        },
        families: {
          title: "Familias y parejas",
          description:
            "Compartes gastos con pareja, familia o roomies? Sincroniza todo en tiempo real sin complicaciones.",
        },
        students: {
          title: "Estudiantes y freelancers",
          description:
            "Presupuesto ajustado? Controla cada peso con una app que respeta tu tiempo y tu bolsillo.",
        },
        power: {
          title: "Usuarios exigentes",
          description:
            "¿Harto de apps complicadas? Bolsi es velocidad pura: registra gastos en menos de 10 segundos.",
        },
      ...
      cta: {
        ...
        subheading:
          "Instala Bolsi y controla cada peso, dólar o real desde el celular.",
      ...
      blog: {
        title: "Blog",
        heroTitle: "Blog de Finanzas Personales",
        heroSubtitle: "Consejos prácticos para ahorrar más y gastar mejor",
        allCategories: "Todas",
        loading: "Cargando artículos...",
        noPostsFound: "No hay artículos disponibles",
        readMore: "Leer más",
        ...
        ctaTitle: "¿Listo para controlar tus gastos?",
        ctaDescription: "Descarga Bolsi y empieza a ahorrar desde hoy",
        ctaButton: "Descargar Gratis",
      },
      privacy: {
        navbar: {
        ...
        section1: {
          ...
          important:
            "<strong>Importante:</strong> Al usar Bolsi, aceptas los términos descritos en esta Política de Privacidad. Si no estás de acuerdo, por favor no uses la aplicación.",
        },
        section2: {
          title: "2. Información que Recopilamos",
          subtitle1: "2.1 Información que Proporcionas",
          item1:
            "<strong>Cuenta de Usuario:</strong> Dirección de correo electrónico y contraseña cuando te registras",
          item2:
            "<strong>Datos Financieros:</strong> Información sobre tus gastos, pagos fijos, movimientos financieros, títulos de gastos, montos y monedas",
          item3:
            "<strong>Datos de Grupos:</strong> Información sobre grupos que creas o a los que te unes para compartir gastos",
          item4:
            "<strong>Preferencias:</strong> Configuraciones de la aplicación, preferencias de visualización de gráficas",
          subtitle2: "2.2 Información que Recopilamos Automáticamente",
          item5:
            "<strong>Información del Dispositivo:</strong> Tipo de dispositivo, sistema operativo, identificadores únicos",
          item6:
            "<strong>Datos de Uso:</strong> Cómo interactúas con la aplicación, funciones utilizadas, frecuencia de uso",
          item7:
            "<strong>Información de Errores:</strong> Reportes de crashes y errores para mejorar la estabilidad de la app",
          item8:
            "<strong>Datos de Publicidad:</strong> Interacciones con anuncios mostrados en la aplicación",
        ...
        section3: {
          ...
          item1:
            "<strong>Proporcionar el Servicio:</strong> Permitirte usar todas las funcionalidades de la app",
          item2:
            "<strong>Sincronización:</strong> Mantener tus datos sincronizados entre tus dispositivos",
          item3:
            "<strong>Personalización:</strong> Adaptar la experiencia según tus preferencias",
          item4:
            "<strong>Mejoras:</strong> Analizar el uso para mejorar funcionalidades y rendimiento",
          item5:
            "<strong>Soporte:</strong> Responder a tus consultas y resolver problemas técnicos",
          item6:
            "<strong>Seguridad:</strong> Detectar y prevenir fraudes o usos indebidos",
          item7:
            "<strong>Comunicaciones:</strong> Enviarte notificaciones importantes sobre la app",
        },
        section4: {
          ...
          item1:
            "<strong>Firebase (Google):</strong> Para almacenamiento de datos y autenticación",
          item2:
            "<strong>Google AdMob:</strong> Para mostrar publicidad relevante (solo en versión gratuita)",
          item3:
            "<strong>Proveedores de Servicios:</strong> Que nos ayudan a operar y mejorar la app",
          item4:
            "<strong>Cumplimiento Legal:</strong> Si es requerido por ley o para proteger nuestros derechos",
        },
        section5: {
          ...
          item2:
            "<strong>Firebase Security Rules:</strong> Restricciones de acceso a nivel de base de datos",
          item3:
            "<strong>Autenticación Segura:</strong> Contraseñas hasheadas, nunca almacenadas en texto plano",
          item4:
            "<strong>Actualizaciones Regulares:</strong> Parches de seguridad aplicados constantemente",
        ...
        section6: {
          ...
          item3:
            "<strong>Eliminar:</strong> Solicitar la eliminación de tu cuenta y datos",
          item4:
            "<strong>Exportar:</strong> Descargar tus datos en formato portable (función Premium)",
          item5:
            "<strong>Oponerte:</strong> Rechazar ciertos usos de tu información",
          item6:
            "<strong>Limitar:</strong> Restringir el procesamiento de tus datos",
        },
        section7: {
        ...
        section9: {
          ...
          intro:
            "<strong>Bolsi NO está dirigida a menores de 13 años.</strong>",
          item1:
            "No recopilamos intencionalmente información de niños menores de 13 años",
          item2:
            "Si descubrimos que hemos recopilado información de un menor de 13 años, la eliminaremos inmediatamente",
          item3:
            "Si eres padre/madre/tutor y crees que tu hijo nos ha proporcionado información, contáctanos",
        },
        section10: {
        ...
        section11: {
          ...
          responseText:
            "Nos comprometemos a responder a tus consultas en un plazo de 7 días hábiles.",
        },
        footer: {
          version: "Versión:",
      ...
      delete: {
        ...
        hero: {
          ...
          subtitle:
            "Información sobre cómo eliminar tu cuenta y datos personales",
        },
        section1: {
          title:
            '<i class="fas fa-exclamation-triangle"></i> Advertencia Importante',
          alert:
            "La eliminación de tu cuenta es <strong>permanente e irreversible</strong>. Todos tus datos serán eliminados definitivamente y no podrán ser recuperados. Por favor, asegúrate de exportar cualquier información que desees conservar antes de proceder.",
        },
        section2: {
          ...
          option2Intro:
            "Si no puedes acceder a la aplicación o prefieres eliminar tu cuenta por correo electrónico, envíanos un email con la siguiente información:",
          emailButton: "Enviar Solicitud de Eliminación",
          emailInfoTitle:
            '<i class="fas fa-info-circle"></i> Información Necesaria para la Solicitud por Email',
          emailInfo1: "Email registrado en tu cuenta de Bolsi",
          emailInfo2:
            "Confirmación de que entiendes que la eliminación es permanente",
          emailInfo3:
            "Razón de la eliminación (opcional pero nos ayuda a mejorar)",
        },
        section3: {
          title: '<i class="fas fa-trash-alt"></i> Datos que se Eliminarán',
          intro:
            "Al eliminar tu cuenta, la siguiente información será eliminada permanentemente:",
        ...
        section4: {
          title:
            '<i class="fas fa-chart-bar"></i> Datos que se Conservarán (Si Aplica)',
          legalTitle:
            '<i class="fas fa-info-circle"></i> Información Legal y Financiera',
          legalIntro:
            "Por razones legales, fiscales y de auditoría, podemos conservar ciertos datos durante períodos específicos:",
          retention1: "• Historial de Transacciones de Pago:",
          retention1desc:
            "Conservado por <strong>7 años</strong> (requisito legal fiscal)",
          retention2: "• Registros de Suscripción Premium:",
          retention2desc:
            "Conservado por <strong>90 días</strong> después de la eliminación (para resolver disputas de pago)",
          retention3: "• Datos Agregados y Anonimizados:",
          retention3desc:
            "Pueden conservarse indefinidamente para análisis estadísticos (sin información personal identificable)",
          retention4: "• Logs de Seguridad:",
          retention4desc:
            "Conservados por <strong>6 meses</strong> (para prevenir fraude y abuso)",
        ...
        section5: {
          ...
          timeline3desc:
            "Datos en servicios de Google (AdMob, Play Billing) según sus políticas",
        },
        section6: {
        ...
        section7: {
          ...
          contactIntro:
            "Si tienes preguntas o problemas durante el proceso de eliminación, contáctanos:",
          email: "Email:",
          app: "App:",
          developer: "Desarrollador:",
    ...
    en: {
      meta: {
        ...
        description:
          "Track expenses, share budgets and save money every month with Bolsi.",
      },
      common: {
      ...
      hero: {
        ...
        description:
          "Tired of messy spreadsheets? Bolsi lets you log expenses in seconds, share with anyone and stay on budget with gentle alerts.",
      ...
      benefits: {
        ...
        subheading:
          "We deliver value before features so you keep using it every day.",
        cards: [
          {
            title: "SUPER EASY TO USE",
            description:
              "Log any expense in under 10 seconds. Built for everyday routines.",
          },
          {
            title: "SHARED EXPENSES, ZERO DRAMA",
            description:
              "Create family, couple or roommate groups with real-time sync.",
          },
          {
            title: "BUDGETS THAT WORK",
            description:
              "Color-coded alerts tell you when you are close to each limit.",
          },
          {
            title: "PRIVATE & SECURE",
            description:
              "Firebase-grade encryption keeps every transaction safe.",
          },
        ],
      },
      features: {
        ...
        subheading:
          "Track recurring bills, daily coffee and every transfer with visual insights.",
        list: [
        ...
        cards: {
          title: "Credit Cards",
          description:
            "Track installment purchases, visualize total debt and manage multiple cards from a unified dashboard.",
        },
        multiCurrency: {
          title: "Multi-currency",
          description:
            "Supports USD, EUR, MXN, ARS, COP, BRL and more. Perfect for travelers or those handling different currencies.",
        },
        alerts: {
          title: "Smart Alerts",
          description:
            "Get notifications when you approach your spending limit or important payment due dates.",
        },
        darkMode: {
          title: "Dark Mode",
          description:
            "Protect your eyes with our elegant dark mode. Switch between light and dark with one tap.",
        },
        reports: {
          title: "Visual Reports",
          description:
            "Pie, bar and line charts to understand your spending patterns. Export reports when needed.",
        },
        security: {
          title: "Firebase Security",
          description:
            "Your data protected by Google infrastructure. Automatic backup and data encryption.",
        },
      },
      howItWorks: {
        ...
        subheading:
          "Setting up your expense tracking is so simple you'll start in less than 2 minutes.",
        step1: {
          title: "Create your fixed expenses",
          description:
            "Define your monthly expenses like rent, utilities, subscriptions. Bolsi will remember them automatically.",
        },
        step2: {
          title: "Record your movements",
          description:
            "Add daily purchases and payments. With just a few taps, keep everything updated in real-time.",
        },
        step3: {
          title: "See your real situation",
          description:
            "Check how much you have available, charts by category and smart alerts to avoid going over budget.",
        },
        bonus: {
          title: "Share with your family",
          description:
            "Create groups to manage shared expenses. Perfect for couples, families or roommates splitting costs.",
        },
      },
      faq: {
        eyebrow: "FAQ",
        ...
        subheading:
          "Bolsi guides you step by step with no finance degree required.",
        items: [
          {
            question: "Do I need finance experience?",
            answer:
              "No. Bolsi explains every step with clear copy and ready-made templates.",
          },
          {
            question: "Is it available worldwide?",
            answer:
              "Yes. Multiple currencies, personal or group contexts and cloud sync.",
          },
          {
            question: "Is it free?",
            answer:
              "Yes, Bolsi is completely free. All main features are available at no cost.",
          },
          {
            question: "Is my data secure?",
            answer:
              "Absolutely. We use Firebase with end-to-end encryption. Only you have access to your financial information.",
          },
          {
            question: "Can I use it offline?",
            answer:
              "Yes, you can record expenses offline and they will sync automatically when you reconnect to the internet.",
          },
        ],
      },
      audience: {
        ...
        subheading:
          "Whether you save solo, with a partner or family, Bolsi adapts to you.",
        beginners: {
          title: "Finance beginners",
          description:
            "Want to start saving but don't know where to begin? Bolsi guides you step by step without jargon.",
        },
        families: {
          title: "Families & couples",
          description:
            "Share expenses with your partner, family or roommates? Sync everything in real-time without hassle.",
        },
        students: {
          title: "Students & freelancers",
          description:
            "Tight budget? Control every penny with an app that respects your time and wallet.",
        },
        power: {
          title: "Power users",
          description:
            "Tired of complicated apps? Bolsi is pure speed: log expenses in under 10 seconds.",
        },
      ...
      cta: {
        ...
        subheading:
          "Install Bolsi and control every peso, dollar or real from your phone.",
      ...
      blog: {
        title: "Blog",
        heroTitle: "Personal Finance Blog",
        heroSubtitle: "Practical tips to save more and spend smarter",
        allCategories: "All",
        loading: "Loading articles...",
        noPostsFound: "No articles available",
        readMore: "Read more",
        ...
        ctaTitle: "Ready to control your expenses?",
        ctaDescription: "Download Bolsi and start saving today",
        ctaButton: "Download Free",
      },
      privacy: {
        navbar: {
        ...
        section1: {
          ...
          important:
            "<strong>Important:</strong> By using Bolsi, you accept the terms described in this Privacy Policy. If you do not agree, please do not use the application.",
        },
        section2: {
          title: "2. Information We Collect",
          subtitle1: "2.1 Information You Provide",
          item1:
            "<strong>User Account:</strong> Email address and password when you register",
          item2:
            "<strong>Financial Data:</strong> Information about your expenses, fixed payments, financial movements, expense titles, amounts and currencies",
          item3:
            "<strong>Group Data:</strong> Information about groups you create or join to share expenses",
          item4:
            "<strong>Preferences:</strong> App settings, chart display preferences",
          ...
          item6:
            "<strong>Usage Data:</strong> How you interact with the app, features used, frequency of use",
          item7:
            "<strong>Error Information:</strong> Crash reports and errors to improve app stability",
          item8:
            "<strong>Advertising Data:</strong> Interactions with ads displayed in the application",
        ...
        section3: {
          ...
          item1:
            "<strong>Provide the Service:</strong> Allow you to use all app functionalities",
          item2:
            "<strong>Synchronization:</strong> Keep your data synced across your devices",
          item3:
            "<strong>Personalization:</strong> Adapt the experience according to your preferences",
          item4:
            "<strong>Improvements:</strong> Analyze usage to improve features and performance",
          item5:
            "<strong>Support:</strong> Respond to your inquiries and resolve technical issues",
          item6:
            "<strong>Security:</strong> Detect and prevent fraud or misuse",
          item7:
            "<strong>Communications:</strong> Send you important notifications about the app",
        },
        section4: {
          ...
          item1:
            "<strong>Firebase (Google):</strong> For data storage and authentication",
          item2:
            "<strong>Google AdMob:</strong> To display relevant advertising (free version only)",
          item3:
            "<strong>Service Providers:</strong> Who help us operate and improve the app",
          item4:
        ...
        section5: {
          ...
          item1:
            "<strong>Encryption:</strong> All data is transmitted via HTTPS",
          item2:
            "<strong>Firebase Security Rules:</strong> Database-level access restrictions",
          item3:
            "<strong>Secure Authentication:</strong> Hashed passwords, never stored in plain text",
          item4:
            "<strong>Regular Updates:</strong> Security patches applied constantly",
        ...
        section6: {
          ...
          item2:
            "<strong>Rectify:</strong> Correct inaccurate or incomplete information",
          item3:
            "<strong>Delete:</strong> Request deletion of your account and data",
          item4:
            "<strong>Export:</strong> Download your data in portable format (Premium feature)",
          item5:
            "<strong>Object:</strong> Refuse certain uses of your information",
        ...
        section9: {
          title: "9. Minors",
          intro:
            "<strong>Bolsi is NOT directed at children under 13 years old.</strong>",
          item1:
            "We do not intentionally collect information from children under 13",
          item2:
            "If we discover we have collected information from a minor under 13, we will delete it immediately",
          item3:
        ...
        section11: {
          ...
          responseText:
            "We are committed to responding to your inquiries within 7 business days.",
        },
        footer: {
          version: "Version:",
      ...
      delete: {
        ...
        hero: {
          ...
          subtitle:
            "Information on how to delete your account and personal data",
        },
        section1: {
          title:
            '<i class="fas fa-exclamation-triangle"></i> Important Warning',
          alert:
            "Deleting your account is <strong>permanent and irreversible</strong>. All your data will be permanently deleted and cannot be recovered. Please make sure to export any information you wish to keep before proceeding.",
        },
        section2: {
          ...
          option2Intro:
            "If you cannot access the app or prefer to delete your account via email, send us an email with the following information:",
          emailButton: "Send Deletion Request",
          emailInfoTitle:
            '<i class="fas fa-info-circle"></i> Information Needed for Email Request',
        ...
        section4: {
          title:
            '<i class="fas fa-chart-bar"></i> Data That Will Be Retained (If Applicable)',
          legalTitle:
            '<i class="fas fa-info-circle"></i> Legal and Financial Information',
          legalIntro:
            "For legal, tax and audit reasons, we may retain certain data for specific periods:",
          retention1: "• Payment Transaction History:",
          retention1desc:
            "Retained for <strong>7 years</strong> (legal tax requirement)",
          retention2: "• Premium Subscription Records:",
          retention2desc:
            "Retained for <strong>90 days</strong> after deletion (to resolve payment disputes)",
          retention3: "• Aggregated and Anonymized Data:",
          retention3desc:
            "May be retained indefinitely for statistical analysis (no personally identifiable information)",
          retention4: "• Security Logs:",
          retention4desc:
            "Retained for <strong>6 months</strong> (to prevent fraud and abuse)",
        ...
        section5: {
          ...
          timeline3desc:
            "Data in Google services (AdMob, Play Billing) according to their policies",
        },
        section6: {
          title:
        ...
        section7: {
          ...
          contactIntro:
            "If you have questions or problems during the deletion process, contact us:",
          email: "Email:",
          app: "App:",
          developer: "Developer:",
    ...
    pt: {
      meta: {
        ...
        description:
          "Controle despesas, compartilhe orçamentos e economize todo mês com Bolsi.",
      },
      common: {
      ...
      hero: {
        ...
        description:
          "Chega de planilhas confusas. Com Bolsi você registra gastos em segundos, divide com quem quiser e recebe alertas antes de estourar o orçamento.",
      ...
      benefits: {
        ...
        subheading:
          "Mostramos o valor antes dos recursos para você usar todos os dias.",
        cards: [
          {
            title: "SUPER FÁCIL DE USAR",
            description:
              "Registre qualquer gasto em menos de 10 segundos. Feito para a rotina.",
          },
          {
            title: "DESPESAS COMPARTILHADAS, SEM DRAMA",
            description:
              "Crie grupos para família, casal ou amigos com sincronização em tempo real.",
          },
          {
            title: "ORÇAMENTOS QUE FUNCIONAM",
            description:
              "Alertas com cores mostram quando você está perto do limite.",
          },
          {
            title: "PRIVADO E 100% SEGURO",
            description:
              "Dados criptografados com Firebase. Só você decide quem vê.",
          },
        ],
      },
      features: {
        ...
        subheading:
          "Controle contas fixas, gastos variáveis e veja insights visuais que fazem sentido.",
        list: [
        ...
        cards: {
          ...
          description:
            "Registre compras parceladas, visualize sua dívida total e gerencie vários cartões de um painel unificado.",
        },
        multiCurrency: {
          title: "Multi-moeda",
          description:
            "Suporta USD, EUR, MXN, ARS, COP, BRL e mais. Perfeito para viajantes ou quem lida com diferentes moedas.",
        },
        alerts: {
          title: "Alertas Inteligentes",
          description:
            "Receba notificações quando se aproximar do limite de gastos ou vencimentos de pagamentos importantes.",
        },
        darkMode: {
          title: "Modo Escuro",
          description:
            "Proteja seus olhos com nosso elegante modo escuro. Alterne entre claro e escuro com um toque.",
        },
        reports: {
          title: "Relatórios Visuais",
          description:
            "Gráficos de pizza, barras e linhas para entender seus padrões de gastos. Exporte relatórios quando precisar.",
        },
        security: {
          title: "Segurança Firebase",
          description:
            "Seus dados protegidos pela infraestrutura do Google. Backup automático e criptografia de dados.",
        },
      },
      howItWorks: {
        ...
        subheading:
          "Configurar seu controle de gastos é tão simples que você começa em menos de 2 minutos.",
        step1: {
          title: "Crie suas despesas fixas",
          description:
            "Defina seus gastos mensais como aluguel, serviços, assinaturas. Bolsi vai lembrar automaticamente.",
        },
        step2: {
          title: "Registre seus movimentos",
          description:
            "Adicione compras e pagamentos do dia a dia. Com poucos toques, mantenha tudo atualizado em tempo real.",
        },
        step3: {
          title: "Veja sua situação real",
          description:
            "Verifique quanto você tem disponível, gráficos por categoria e alertas inteligentes para não estourar o orçamento.",
        },
        bonus: {
          title: "Compartilhe com sua família",
          description:
            "Crie grupos para gerenciar despesas compartilhadas. Perfeito para casais, famílias ou colegas de quarto que dividem custos.",
        },
      },
      faq: {
        ...
        items: [
          {
            ...
            answer:
              "Não. Bolsi traz textos claros, lembretes inteligentes e modelos prontos.",
          },
          {
            question: "Funciona em vários países?",
            answer:
              "Sim. Multi-moeda, contextos pessoais ou em grupo e nuvem segura.",
          },
          {
            question: "É grátis?",
            answer:
              "Sim, Bolsi é completamente gratuito. Todas as funcionalidades principais estão disponíveis sem custo.",
          },
          {
            question: "Meus dados estão seguros?",
            answer:
              "Absolutamente. Usamos Firebase com criptografia ponta a ponta. Apenas você tem acesso às suas informações financeiras.",
          },
          {
            question: "Posso usar sem conexão?",
            answer:
              "Sim, você pode registrar gastos offline e eles sincronizarão automaticamente quando você voltar a ter internet.",
          },
        ],
      },
      audience: {
        ...
        subheading:
          "Seja para economizar sozinho, em casal ou família, Bolsi acompanha você.",
        beginners: {
          title: "Iniciantes em finanças",
          description:
            "Quer começar a economizar mas não sabe por onde? Bolsi te guia passo a passo sem jargões.",
        },
        families: {
          title: "Famílias e casais",
          description:
            "Divide despesas com parceiro, família ou amigos? Sincronize tudo em tempo real sem complicações.",
        },
        students: {
          title: "Estudantes e freelancers",
          description:
            "Orçamento apertado? Controle cada centavo com um app que respeita seu tempo e bolso.",
        },
        power: {
          title: "Usuários exigentes",
          description:
            "Cansou de apps complicados? Bolsi é velocidade pura: registre gastos em menos de 10 segundos.",
        },
      ...
      blog: {
        title: "Blog",
        heroTitle: "Blog de Finanças Pessoais",
        heroSubtitle: "Dicas práticas para economizar mais e gastar melhor",
        allCategories: "Todas",
        loading: "Carregando artigos...",
        noPostsFound: "Nenhum artigo disponível",
        readMore: "Ler mais",
        ...
        ctaTitle: "Pronto para controlar seus gastos?",
        ctaDescription: "Baixe o Bolsi e comece a economizar hoje",
        ctaButton: "Baixar Grátis",
      },
      privacy: {
        navbar: {
        ...
        section1: {
          ...
          important:
            "<strong>Importante:</strong> Ao usar o Bolsi, você aceita os termos descritos nesta Política de Privacidade. Se não concordar, por favor não use a aplicação.",
        },
        section2: {
          title: "2. Informações que Coletamos",
          subtitle1: "2.1 Informações que Você Fornece",
          item1:
            "<strong>Conta de Usuário:</strong> Endereço de email e senha quando você se registra",
          item2:
            "<strong>Dados Financeiros:</strong> Informações sobre seus gastos, pagamentos fixos, movimentos financeiros, títulos de gastos, valores e moedas",
          item3:
            "<strong>Dados de Grupos:</strong> Informações sobre grupos que você cria ou aos quais se junta para compartilhar despesas",
          item4:
            "<strong>Preferências:</strong> Configurações do aplicativo, preferências de visualização de gráficos",
          subtitle2: "2.2 Informações que Coletamos Automaticamente",
          item5:
            "<strong>Informações do Dispositivo:</strong> Tipo de dispositivo, sistema operacional, identificadores únicos",
          item6:
            "<strong>Dados de Uso:</strong> Como você interage com o aplicativo, recursos utilizados, frequência de uso",
          item7:
            "<strong>Informações de Erros:</strong> Relatórios de crashes e erros para melhorar a estabilidade do app",
          item8:
            "<strong>Dados de Publicidade:</strong> Interações com anúncios exibidos no aplicativo",
        ...
        section3: {
          ...
          item1:
            "<strong>Fornecer o Serviço:</strong> Permitir que você use todas as funcionalidades do app",
          item2:
            "<strong>Sincronização:</strong> Manter seus dados sincronizados entre seus dispositivos",
          item3:
            "<strong>Personalização:</strong> Adaptar a experiência de acordo com suas preferências",
          item4:
            "<strong>Melhorias:</strong> Analisar o uso para melhorar funcionalidades e desempenho",
          item5:
            "<strong>Suporte:</strong> Responder às suas consultas e resolver problemas técnicos",
          item6:
            "<strong>Segurança:</strong> Detectar e prevenir fraudes ou usos indevidos",
          item7:
            "<strong>Comunicações:</strong> Enviar notificações importantes sobre o app",
        },
        section4: {
          title: "4. Compartilhamento de Informações",
          intro:
            "<strong>NÃO vendemos nem alugamos suas informações pessoais a terceiros.</strong>",
          p1: "Podemos compartilhar informações limitadas com:",
          item1:
            "<strong>Firebase (Google):</strong> Para armazenamento de dados e autenticação",
          item2:
            "<strong>Google AdMob:</strong> Para exibir publicidade relevante (apenas na versão gratuita)",
          item3:
            "<strong>Provedores de Serviços:</strong> Que nos ajudam a operar e melhorar o app",
          item4:
            "<strong>Cumprimento Legal:</strong> Se exigido por lei ou para proteger nossos direitos",
        },
        section5: {
          title: "5. Segurança dos Dados",
          intro: "Implementamos múltiplas medidas de segurança:",
          item1:
            "<strong>Criptografia:</strong> Todos os dados são transmitidos via HTTPS",
          item2:
            "<strong>Firebase Security Rules:</strong> Restrições de acesso em nível de banco de dados",
          item3:
            "<strong>Autenticação Segura:</strong> Senhas hash, nunca armazenadas em texto simples",
          item4:
            "<strong>Atualizações Regulares:</strong> Patches de segurança aplicados constantemente",
        ...
        section6: {
          ...
          item1:
            "<strong>Acessar:</strong> Solicitar uma cópia de seus dados pessoais",
          item2:
            "<strong>Retificar:</strong> Corrigir informações incorretas ou incompletas",
          item3:
            "<strong>Excluir:</strong> Solicitar a exclusão de sua conta e dados",
          item4:
            "<strong>Exportar:</strong> Baixar seus dados em formato portável (recurso Premium)",
          item5:
            "<strong>Opor-se:</strong> Recusar certos usos de suas informações",
          item6:
            "<strong>Limitar:</strong> Restringir o processamento de seus dados",
        },
        section7: {
        ...
        section9: {
          ...
          intro:
            "<strong>Bolsi NÃO é direcionado a menores de 13 anos.</strong>",
          item1:
            "Não coletamos intencionalmente informações de crianças menores de 13 anos",
          item2:
            "Se descobrirmos que coletamos informações de um menor de 13 anos, as excluiremos imediatamente",
          item3:
            "Se você é pai/mãe/tutor e acredita que seu filho nos forneceu informações, entre em contato",
        },
        section10: {
          title: "10. Atualizações desta Política",
          intro:
            "Podemos atualizar esta Política de Privacidade ocasionalmente. Notificaremos você sobre mudanças significativas através de:",
        ...
        section11: {
          ...
          responseText:
            "Nos comprometemos a responder às suas consultas em um prazo de 7 dias úteis.",
        },
        footer: {
          version: "Versão:",
      ...
      delete: {
        ...
        section1: {
          ...
          alert:
            "A exclusão da sua conta é <strong>permanente e irreversível</strong>. Todos os seus dados serão excluídos definitivamente e não poderão ser recuperados. Por favor, certifique-se de exportar qualquer informação que deseje manter antes de prosseguir.",
        },
        section2: {
          ...
          option2Intro:
            "Se você não conseguir acessar o aplicativo ou preferir excluir sua conta por email, envie-nos um email com as seguintes informações:",
          emailButton: "Enviar Solicitação de Exclusão",
          emailInfoTitle:
            '<i class="fas fa-info-circle"></i> Informações Necessárias para Solicitação por Email',
          emailInfo1: "Email registrado na sua conta Bolsi",
          emailInfo2:
            "Confirmação de que você entende que a exclusão é permanente",
        ...
        section3: {
          ...
          intro:
            "Ao excluir sua conta, as seguintes informações serão excluídas permanentemente:",
          ...
          item2desc:
            "Todas as despesas, pagamentos fixos e movimentos registrados",
          item3: '<i class="fas fa-check"></i> Grupos/Contextos:',
        ...
        section4: {
          title:
            '<i class="fas fa-chart-bar"></i> Dados que Serão Mantidos (Se Aplicável)',
          legalTitle:
            '<i class="fas fa-info-circle"></i> Informação Legal e Financeira',
          legalIntro:
            "Por razões legais, fiscais e de auditoria, podemos manter certos dados por períodos específicos:",
          retention1: "• Histórico de Transações de Pagamento:",
          retention1desc:
            "Mantido por <strong>7 anos</strong> (requisito legal fiscal)",
          retention2: "• Registros de Assinatura Premium:",
          retention2desc:
            "Mantido por <strong>90 dias</strong> após a exclusão (para resolver disputas de pagamento)",
          retention3: "• Dados Agregados e Anonimizados:",
          retention3desc:
            "Podem ser mantidos indefinidamente para análises estatísticas (sem informações pessoais identificáveis)",
          retention4: "• Logs de Segurança:",
          retention4desc:
            "Mantidos por <strong>6 meses</strong> (para prevenir fraude e abuso)",
        ...
        section5: {
          ...
          timeline3desc:
            "Dados em serviços do Google (AdMob, Play Billing) conforme suas políticas",
        },
        section6: {
        ...
        section7: {
          ...
          contactIntro:
            "Se você tiver dúvidas ou problemas durante o processo de exclusão, entre em contato:",
          email: "Email:",
          app: "App:",
          developer: "Desenvolvedor:",
